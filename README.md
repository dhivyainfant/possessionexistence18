...
Each (Possessor, Possessee) pair has annotations for 

Possession Existence (Yes/Never/Unknown/Invalid), 

possession type (Alienable/Control) and 

three temporal tags Before (Yes/No), During (Yes/No) and  After (Yes/No) as explained in section 4.2.
